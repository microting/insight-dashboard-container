...
rm backup-*.sql
echo "Restoring Insight Dashboard for customer with no $1"

DATABASE_NAME="$1_eform-angular-insight-dashboard-plugin"
DOWNLOAD_PATH="microting-angular-plugin-backups/$1/eform-angular-insight-dashboard-plugin/"
